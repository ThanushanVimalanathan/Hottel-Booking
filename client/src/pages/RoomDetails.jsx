...
const RoomDetails = () => {
    ...
    useEffect(()=>{
       const room = roomsDummyData.find(room => room._id === id) /* get room datas from Id */
       room && setRoom(room) 
  ...
  return  room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/**Room Address */}
      <div className='flex items-center gap-1 text-1 text-gray-500 mt-2'>
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between
          ...
          <div className='flex flex-col flex-wrap md:flex-row 
             ...
             <div className='flex flex-col'>
                        ...
                        <input className='w-full rounded border border-gray-300 px-3
              ...
              <div className='flex flex-col'>
                        ...
                        <input className='w-full rounded border border-gray-300 px-3
                               py-2 mt-1.5 outline-none' type="date"  id='checOutDate' 
